  ...
  return (
    <footer className="bg-stone-800 text-stone-300 mt-20">
      <div className="max-w-5xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-sm text-stone-400 leading-relaxed">
            Handgemaakt keramiek voor buiten, geïnspireerd op de natuur.
            Atelier van Marjolein IJbema.
          </p>
        </div>

        <div>
          <h4 className="text-sm font-semibold uppercase tracking-widest text-stone-400 mb-3">
            Navigatie
          </h4>
      ...
      <div className="border-t border-stone-700 py-4 text-center text-xs text-stone-500">
        © {new Date().getFullYear()} Curious Magpie · Marjolein IJbema
      </div>
    </footer>
  );
}
